...
ShowerParametrization::ShowerParametrization(const Parameters::Shower& params): moliereRadius_(params.moliere_radius){
...
std::array<double,52>& ShowerParametrization::getLayerProfile(int pdgid) {
...
std::array<double,3> ShowerParametrization::spotEnergy(int pdgid){
