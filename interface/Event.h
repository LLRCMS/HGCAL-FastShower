...
class Event {
    ...
    public:
        ...
        const std::unordered_map<uint32_t, double>& gen_en() const {return generated_energy_;}
        const std::unordered_map<uint32_t, double>& gen_eta() const {return generated_eta_;}
